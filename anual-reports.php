      ...
      <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <a id="pdfDownloadBtn" href="" download class="btn btn-primary" target="_blank">
            ...
            const cardphp = `
                <div class="col-12 col-sm-6 col-md-4 mb-4">
                    <div class="card h-100 bg-transparent border-0">
                        <div onclick="openPdfModal('${item.pdf}', '${item.title}')" class="shadow-sm text-center bg-white" style=" display: flex; align-items: center; justify-content: center; border: 1px solid #eee; border-radius: 8px; overflow:hidden">
                            <img src="${item.image}" alt="${item.title}" style="min-height: 100%; width: 100%; object-fit: cover;">
                        </div>
