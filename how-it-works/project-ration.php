...
<head>
    ...
    <title>AWDORG Foundation - Project Ration</title>
...
<div class="container-fluid pt-4"></div>
    <div class="main-card">
        <div class="header-title">
            ...
            <p>5 Kg Wheat Flour + 2 Kg Lentil + 1 Kg Sugar + 500 Gram Tea + 1 Kg Sugar + 1 Ltr Cooking Oil + 1 Kg Salt</p>
            <p>PROJECTration is an ongoing food programme and we are more than willing to help any needy. During Lockdown we ran many cooked food drives in Delhi NCR, Haryana, UP., Punjab & Uttrakhand. we are keen to help pan India at any given time.</p>    
        ...
        <h3 class="text-center">Hygienic cooked food prepared & distributed during Covid19 lockdown</h3>
